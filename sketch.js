...
function setup() {
   ...
   rope = new Rope (bob.p,roof.body,-80,0);
   rope2 = new Rope (bob2.p,roof.body,0,0);
   rope3 = new Rope (bob3.p,roof.body,30,0);
   rope4 = new Rope (bob4.p,roof.body,40,0);
   rope5 = new Rope (bob5.p,roof.body,80,0);
